...
abstract class BankBase {
  ...
  protected val customerRepo: CustomerRepository = new CustomerRepositoryImpl
  protected val accountRepo: AccountRepository = new AccountRepositoryImpl
  protected val transactionRepo: TransactionRepository = new TransactionRepositoryImpl
  protected val transactionManager = new TransactionManager( accountRepo, transactionRepo)
   ...
   */
  private val savingsAccountInterestMap = Map(1000 -> 0.1, Integer.MAX_VALUE -> 0.2)

  private val maxSavingsAccountInterestMap = Map(1000 -> 2.0, 2000 -> 5.0, Integer.MAX_VALUE -> 10.0)
